...
data = dict(
    ...
    val=dict(type=dataset_type, ann_file=ann_file, split='val', pipeline=val_pipeline),   # test1
    test=dict(type=dataset_type, ann_file=ann_file, split='val', pipeline=test_pipeline)) # test1
# optimizer
...
log_level = 'INFO'
work_dir = './work_dirs/posec3d/slowonly_r50_test01_k400p/s1_joint'
